...
<?php
 if(isset($_POST['add_activo'])){
   ...
   if(empty($errors)){
     ...
     $query .=" name,cantidad,stock,categorie_id,media_id,date";
     $query .=") VALUES (";
     $query .=" '{$p_name}', '{$p_cant}', '{$p_stock}', '{$p_cat}', '{$media_id}', '{$date}'";
     $query .=")";
     $query .=" ON DUPLICATE KEY UPDATE name='{$p_name}'";
     if($db->query($query)){
       $session->msg('s',"Activo agregado exitosamente. ");
       redirect('add_activo.php', false);
     } else {
  ...
  <div class="col-md-9">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
         <div class="col-md-12">
          <form method="post" action="add_activo.php" class="clearfix">
                 ...
                 <div class="col-md-4">
                  ...
                  <!--<div class="col-md-4">
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" name="saleing-price" placeholder="Salida">
                      <span class="input-group-addon">0</span>
                   </div>
                  </div>-->
               </div>
              </div>
              <button type="submit" name="add_activo" class="btn btn-danger">Agregar Activo</button>
          </form>
         </div>
        </div>
      </div>
