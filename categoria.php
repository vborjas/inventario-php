              ...
              <?php foreach ($all_categories as $cat):?>
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        <a href="edit_categoria.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-xs btn-warning" data-toggle="tooltip" title="Editar">
                          <span class="glyphicon glyphicon-edit"></span>
                        </a>
                        <a href="delete_categoria.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-xs btn-danger" data-toggle="tooltip" title="Eliminar">
